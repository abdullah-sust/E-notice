...
import Database.StudentNotices;
 ...
 */
@WebServlet(name = "StudentNextPrevCombo", urlPatterns = {"/StudentNextPrevCombo"})
public class StudentNextPrevCombo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (tempSession.getAttribute("accountType") == null || !tempSession.getAttribute("accountType").equals("1")) {
            ...
            try {
                ...
                System.out.println("In StudentNextPrevCombo");

                String studentId = (String) tempSession.getAttribute("id");
                ...
                StudentNotices studentNotices = new StudentNotices();
                studentNotices.allNotices(dropdown, studentId, search);

                tempSession.setAttribute("pageNumber", current + "");
                response.sendRedirect("studentBoard.jsp");
            } catch (Exception e) {
                System.out.println("Exception in StudentNextPrevCombo");
                e.printStackTrace();
            }
        }
    }
